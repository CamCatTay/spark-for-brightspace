...
import { spark_dark_mode, d2l_dark_mode } from "../core/settings";
import { chrome_storage_get, chrome_storage_set } from "../shared/utils/chrome-storage-utils";
import { USER_SETTINGS, SPARK_DARK_MODE } from "../shared/constants/storage-keys";
...
export async function set_dark_mode(enabled: boolean): Promise<void> {
    ...
    sync_theme_to_dom(spark_dark_mode, d2l_dark_mode);
}
